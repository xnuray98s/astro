export default {
  ...
  viteConfig(options) {
    ...
    return {
      ...
      optimizeDeps: {
        include: nestedDeps,
        exclude: ['solid-js/package.json', '@astrojs/renderer-solid/server.js'],
      },
      ssr: {
        external: ['solid-js/web/dist/server.js', 'solid-js/store/dist/server.js', 'solid-js/dist/server.js', 'babel-preset-solid', 'babel-plugin-module-resolver', '@babel/core'],
      },
    };
  },
};
